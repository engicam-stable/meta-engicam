...
*******************************************************************************/
#define CsrWifiRouterCtrlWifiOnIndCreate(msg__, dst__, src__, clientData__, status__, versions__, fwReload__) \
    ...
    msg__->fwReload = (fwReload__);

#define CsrWifiRouterCtrlWifiOnIndSendTo(dst__, src__, clientData__, status__, versions__, fwReload__) \
    { \
        CsrWifiRouterCtrlWifiOnInd *msg__; \
        CsrWifiRouterCtrlWifiOnIndCreate(msg__, dst__, src__, clientData__, status__, versions__, fwReload__); \
        CsrSchedMessagePut(dst__, CSR_WIFI_ROUTER_CTRL_PRIM, msg__); \
    }

#define CsrWifiRouterCtrlWifiOnIndSend(dst__, clientData__, status__, versions__, fwReload__) \
    CsrWifiRouterCtrlWifiOnIndSendTo(dst__, CSR_WIFI_ROUTER_IFACEQUEUE, clientData__, status__, versions__, fwReload__)
