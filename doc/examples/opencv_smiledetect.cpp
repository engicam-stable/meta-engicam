...
int main( int argc, const char** argv )
{
	...
	cout << cvGetCaptureProperty(capture,CV_CAP_PROP_FRAME_WIDTH)  << endl;
	cout << cvGetCaptureProperty(capture,CV_CAP_PROP_FRAME_HEIGHT)  << endl;
	...
	timespec time1, time2,time3,time4;
	    ...
	    clock_gettime(CLOCK_PROCESS_CPUTIME_ID, &time4);
	     ...
	     //cout<<diff(time1,time3).tv_sec<<":"<<diff(time1,time3).tv_nsec<<endl;
	     cout<< "MAINLOOP " << diff(time1,time4).tv_sec<<":"<<diff(time1,time4).tv_nsec<<endl;
